...
new class extends Component
{
    ...
    public function submit(): void
    {
        ...
        $this->redirect(route('dashboard.brands.index'), navigate: true);
    }
}; ?>
...
<div>
    ...
    <flux:modal name="create" class="md:w-lg w-sm text-start">
        <form wire:submit="submit" class="space-y-6">
            <div>
                <flux:heading size="base">{{ __('إضافة علامة تجارية جديدة') }}</flux:heading>
                <flux:text class="mt-2">{{ __('أدخل اسم العلامة التجارية الجديدة.') }}</flux:text>
            </div>
